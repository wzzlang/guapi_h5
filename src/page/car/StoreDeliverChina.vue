<template>
  <div v-if="list.parces" class="pick pdt pbb">
    ...
    <div class="pick-item white">
      ...
      <div v-if="sender" class="pick-cont">
        <div class="pick-sec flex-box">
          <p class="pick-sec-tit">发件人姓名</p>
          <p class="pick-sec-p flex">{{sender.name}}</p>
        </div>
        <div class="pick-sec flex-box">
          <p class="pick-sec-tit">发件人中国手机</p>
          <p class="pick-sec-p flex">{{sender.cmobile}}</p>
        </div>
      </div>
    </div>
    <div class="pick-item white">
    ...
    <div class="pick-item white">
      <div class="pick-cont">
        ...
        <p>所有的运费均为预估费用，在核实了实际重量后，会将多收的钱退还到会员余额中</p>
      </div>
    </div>
    <div class="pick-item white">
      <div class="pick-title flex-box middle">
    ...
    <div @click="submitTap" class="submit-btn">提交商城直发</div>
  </div>
</template>
